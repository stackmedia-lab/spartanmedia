...
const services = [
  {
    ...
    desc: 'Full-funnel paid social campaigns engineered for measurable outcomes. We handle everything from account architecture and audience strategy to creative testing and daily optimization across every major social platform.',
    features: ['Campaign architecture & structure', 'Audience research & segmentation', 'Creative testing frameworks', 'Funnel strategy (TOF / MOF / BOF)', 'Daily bid & budget optimization', 'Monthly performance reporting'],
  },
  {
    icon: BarChart3,
    num: '002',
    ...
    features: ['Keyword research & mapping', 'Search & Shopping campaigns', 'Smart bidding strategy', 'Ad copy & extension optimization', 'Quality Score improvement', 'Competitor conquest strategies'],
  },
  {
    icon: TrendingUp,
    num: '003',
  ...
  },
  {
    ...
    desc: 'Robust measurement infrastructure so you always know what\'s working. We implement multi-touch attribution models, build live performance dashboards, and provide the data clarity needed to make confident scaling decisions.',
      ...
      <section className="py-24 px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {['Meta Ads', 'Google Ads', 'TikTok Ads', 'Snapchat Ads', 'Pinterest Ads', 'LinkedIn Ads', 'Microsoft Bing', 'Amazon DSP', 'DV360', 'The Trade Desk', 'YouTube Ads', 'Reddit Ads', 'Twitter / X Ads', 'Connected TV'].map(p => (
              <span key={p} className="border border-gray-200 rounded-sm px-4 py-2 text-xs font-medium text-gray-600 tracking-wide bg-white">
                {p}
              </span>
            ))}
          </div>
      ...
      <section className="py-24 px-6 lg:px-8 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm max-w-lg">Apply for a free audit and we'll map the right services to your growth goals.</p>
          </div>
