        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <a
                href="/apply"
                className="inline-flex items-center gap-1.5 text-xs tracking-widest uppercase font-semibold text-black hover:text-gray-600 transition-colors"
              >
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <div className="flex gap-3">
                {['Twitter', 'LinkedIn', 'Instagram'].map(s => (
                  <a key={s} href="#" className="text-xs tracking-widest uppercase text-gray-400 hover:text-black transition-colors font-medium">
                    {s}
                  </a>
                ))}
              </div>
              ...
              <form onSubmit={handleSubmit} className="border border-gray-100 rounded-sm p-8 lg:p-10 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your goals, current challenges, or what you'd like to discuss..."
                ...
                <button
                  type="submit"
                  className="bg-black text-white text-xs tracking-widest uppercase font-semibold px-8 py-4 rounded-sm hover:bg-gray-900 transition-colors w-full sm:w-auto"
                >
                  Send Message
                </button>
              </form>
