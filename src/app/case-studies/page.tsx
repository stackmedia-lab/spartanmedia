...
const caseStudies = [
  {
    ...
    description: 'A direct-to-consumer fashion brand came to us spending $30K/mo on Meta with a 2.1x ROAS and rising CAC. Within 90 days we rebuilt their account architecture, launched a systematic creative testing program, and expanded to TikTok. Today they are spending $180K/mo at a sustained 6.8x ROAS.',
    stats: [
  ...
  },
  {
    ...
    stats: [
      { label: 'CAC', value: '-61%', change: '$480 to $187' },
  ...
  },
  {
    ...
    title: 'Supplement Brand Tripled Revenue in 90 Days',
    description: 'A health supplement brand with strong organic traction but minimal paid presence. We built a full paid social program from scratch across Meta, TikTok, and YouTube, with a creative strategy built around UGC and testimonials. Revenue tripled in 90 days and the brand raised a $12M Series A.',
    stats: [
  ...
  },
  {
    ...
    stats: [
      ...
      { label: 'Retail Doors', value: '28', change: 'partnerships' },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { label: 'Pipeline to Spend', value: '12x', change: 'return' },
      { label: 'CAC', value: '-66%', change: 'vs. previous agency' },
      { label: 'Enterprise Deals', value: '12', change: 'closed' },
    ],
              ...
              <div className="p-8 lg:p-12">
                ...
                <div className="grid lg:grid-cols-12 gap-8">
                  <div className="lg:col-span-5">
                    ...
                    <p className="text-xs text-gray-400">Duration: <span className="font-medium text-gray-600">{cs.duration}</span></p>
                  </div>
      ...
      <section className="py-24 px-6 lg:px-8 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">Apply for a free audit and see what is possible for your ad accounts.</p>
          </div>
