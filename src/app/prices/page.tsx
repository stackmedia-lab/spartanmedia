...
const plans = [
  ...
  {
    tier: 'Growth',
    price: { monthly: 5500, annual: 4400 },
    tagline: 'Advanced multi-channel growth engine.',
    desc: 'For brands spending $50K–$200K/mo who need a full-service performance partner across channels.',
    features: [
      '3 paid channels managed',
      'Full account architecture',
      'Monthly creative briefs (8)',
  ...
  {
    tier: 'Pro',
    price: { monthly: 10500, annual: 8400 },
    tagline: 'Custom neural media architecture.',
...
const faqs = [
  ...
  { q: 'Is there a minimum ad spend requirement?', a: 'Yes. For Core we recommend a minimum of $10K/mo in ad spend to see meaningful results. Growth requires $50K+, Pro requires $200K+, and Scale is for $1M+ budgets.' },
  { q: 'Do you require long-term contracts?', a: 'All plans are billed monthly. We offer a 20% discount for annual commitments paid upfront. We don\'t lock clients in — our retention comes from performance.' },
  { q: 'What\'s included in the free audit?', a: 'The free audit covers your ad account structure, creative performance, audience strategy, attribution setup, and competitor positioning. You\'ll receive a 15-page report with specific recommendations regardless of whether you proceed.' },
  { q: 'How quickly can you onboard?', a: 'Onboarding typically takes 5–10 business days from signed agreement. This includes account access, strategy sessions, and campaign architecture before any spend goes live.' },
  { q: 'Do you provide ad creative?', a: 'We provide creative strategy, briefs, and copy on all plans. Full creative production (video, photography, design) is available as an add-on service or we can manage your existing creative team.' },
];
    ...
    <>
      ...
      <section className="pt-40 pb-24 px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-semibold leading-tight tracking-tight mb-6">
            Flexible intelligence tiers<br />
          ...
          {/* Toggle */}
          <div className="inline-flex items-center gap-3 border border-gray-200 rounded-sm p-1">
            <button
            ...
            <button
              ...
              className={`px-4 py-1.5 text-xs tracking-widest uppercase font-medium rounded-sm transition-colors flex items-center gap-1.5 ${annual ? 'bg-black text-white' : 'text-gray-400 hover:text-black'}`}
            >
              Annually <span className={`text-[10px] ${annual ? 'text-white/70' : 'text-green-600'}`}>(Save 20%)</span>
            </button>
          </div>
        </div>
      </section>
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`rounded-sm flex flex-col ${
                plan.highlighted
                  ? 'bg-[#0A0A0A] text-white border border-black'
                  : 'bg-white border border-gray-100 hover:border-gray-300'
              } transition-all`}
            >
              <div className="p-8 flex-1">
                <p className={`text-xs tracking-widest uppercase font-medium mb-6 ${plan.highlighted ? 'text-gray-400' : 'text-gray-400'}`}>
                  {plan.tier}
                </p>
                {plan.price.monthly ? (
                  <div className="mb-2">
                ...
                <p className={`text-xs mb-1 ${plan.highlighted ? 'text-gray-400' : 'text-gray-400'}`}>
                  {annual && plan.price.annual ? 'USD Billed Annually' : plan.price.monthly ? 'USD Billed Monthly' : 'Contact for pricing'}
                </p>
                <p className={`text-sm mb-6 mt-4 leading-relaxed ${plan.highlighted ? 'text-gray-300' : 'text-gray-500'}`}>
                  {plan.desc}
                </p>
              ...
              <div className="p-8 pt-0">
                <Link
                  ...
                  className={`w-full block text-center text-xs tracking-widest uppercase font-semibold px-5 py-3.5 rounded-sm transition-colors ${
                    plan.highlighted
      ...
      <section className="py-24 px-6 lg:px-8 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs tracking-widest uppercase text-gray-400 mb-4 font-medium text-center">Common Queries</p>
      ...
      <section className="py-24 px-6 lg:px-8 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm mb-8 max-w-md mx-auto">Apply for a free account audit. We'll recommend the right plan based on your goals and budget.</p>
